...
class WalletTest (KazuGoldTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 KGLD from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 KGLD with subtract fee from amount
        ...
        # Sendmany 10 KGLD with subtract fee from amount
        ...
        #     '-zapwallettxes=1',
        #     '-zapwallettxes=2',
        #     # disabled until issue is fixed: https://github.com/kazugold/kazugold/issues/7463
        #     # '-salvagewallet',
        # ]
