...
class RawTransactionsTest(KazuGoldTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid kazugold address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid kazugold address" in e.error['message'])
