...
This document provides guidelines for internationalization of the KazuGold Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `kazugold_en.ts` remains unchanged.
