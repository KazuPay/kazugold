...
unlocked to sign the KazuGold-Qt.app bundle.
...
allowing somebody to distribute a KazuGold-Qt.app or kazugold-qt-setup.exe with a valid
...
that the kazugold-qt.exe file inside the installer had not been tampered with.
