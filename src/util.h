 ...
 */
#ifndef KGLDCOIN_UTIL_H
#define KGLDCOIN_UTIL_H
...
extern const char * const KGLDCOIN_CONF_FILENAME;
extern const char * const KGLDCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("kazugold-%s", name);
