/* src/config/kazugold-config.h.  Generated from kazugold-config.h.in by configure.  */
/* src/config/kazugold-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef KGLDCOIN_CONFIG_H

#define KGLDCOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The KazuGold Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "KazuGold Core"
...
#define PACKAGE_BUGREPORT "https://github.com/kazucoin/kazugold/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "KazuGold Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "KazuGold Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "kazugold"
