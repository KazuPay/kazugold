...
#ifndef KGLDCOIN_WALLET_KGLDTECH_H
#define KGLDCOIN_WALLET_KGLDTECH_H
...
#define KGLDTECH_DEFAULT_INPUT_DELAY 1
#define KGLDTECH_DEFAULT_OUT_DELAY 10
#define KGLDTECH_DEFAULT_ENTROPY 4
...
#endif //KGLDCOIN_WALLET_KGLDTECH_H
