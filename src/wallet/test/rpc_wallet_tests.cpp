...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CKazuGoldAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CKazuGoldAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CKazuGoldAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CKazuGoldAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CKazuGoldAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CKazuGoldAddress(arr[0].get_str()).Get() == demoAddress.Get());
