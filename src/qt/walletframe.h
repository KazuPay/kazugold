...
#ifndef KGLDCOIN_QT_WALLETFRAME_H
#define KGLDCOIN_QT_WALLETFRAME_H
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, KazuGoldGUI *_gui = 0);
    ~WalletFrame();
...
#endif // KGLDCOIN_QT_WALLETFRAME_H
