...
#ifndef KGLDCOIN_QT_KGLDCOINUNITS_H
#define KGLDCOIN_QT_KGLDCOINUNITS_H
...
/** KazuGold unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class KazuGoldUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KazuGoldUnits(QObject *parent);

    /** KazuGold units.
      @note Source: https://en.kazugold.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        KGLD,
...
typedef KazuGoldUnits::Unit KazuGoldUnit;

#endif // KGLDCOIN_QT_KGLDCOINUNITS_H
