...
public:
    TxViewDelegate(const PlatformStyle *platformStyle):
        QAbstractItemDelegate(), unit(KazuGoldUnits::KGLD),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        QString amountText = KazuGoldUnits::formatWithUnit(unit, amount, true, KazuGoldUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& stakingBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(KazuGoldUnits::formatWithUnit(unit, balance, false, KazuGoldUnits::separatorAlways));
    ui->labelUnconfirmed->setText(KazuGoldUnits::formatWithUnit(unit, unconfirmedBalance, false, KazuGoldUnits::separatorAlways));
    ui->labelStaking->setText(KazuGoldUnits::formatWithUnit(unit, stakingBalance, false, KazuGoldUnits::separatorAlways));
    ui->labelImmature->setText(KazuGoldUnits::formatWithUnit(unit, immatureBalance, false, KazuGoldUnits::separatorAlways));
    ui->labelTotal->setText(KazuGoldUnits::formatWithUnit(unit, balance + unconfirmedBalance + stakingBalance, false, KazuGoldUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("KGLD")
    updateDisplayUnit();
}
...
void OverviewPage::updateStakeReport(bool fImmediate=false)
{
    ...
    ui->label24hStakingStats->setText(KazuGoldUnits::formatWithUnit(unit, aRange[i++].Total, false, KazuGoldUnits::separatorAlways));
    ui->label7dStakingStats->setText(KazuGoldUnits::formatWithUnit(unit, aRange[i++].Total, false, KazuGoldUnits::separatorAlways));
    ui->label30dStakingStats->setText(KazuGoldUnits::formatWithUnit(unit, aRange[i++].Total, false, KazuGoldUnits::separatorAlways));
    ui->label1yStakingStats->setText(KazuGoldUnits::formatWithUnit(unit, aRange[i++].Total, false, KazuGoldUnits::separatorAlways));
    ui->labelallStakingStats->setText(KazuGoldUnits::formatWithUnit(unit, aRange[i++].Total, false, KazuGoldUnits::separatorAlways));
}
