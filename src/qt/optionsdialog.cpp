    ...
    mapper(0)
{
    ...
    ui->kazugoldAtStartup->setToolTip(ui->kazugoldAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->kazugoldAtStartup->setText(ui->kazugoldAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->thirdPartyTxUrls->setPlaceholderText("https://gold.kazuexplore.com/tx/%s");
#endif

    ui->unit->setModel(new KazuGoldUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->kazugoldAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openKazuGoldConfButton_clicked()
{
