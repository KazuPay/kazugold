...
#ifndef KGLDCOIN_TEST_SCRIPTNUM10_H
#define KGLDCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from KazuGold Core 0.10.0, for cross-comparison.
 */
public:
