...
#define BOOST_TEST_MODULE KazuGold Test Suite

#include "test_kazugold.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_kazugold_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
